...
const PAGES = [
  ...
  page({
    ...
    title_tr: 'Web Sitesi Trafik Paketleri', title_en: 'Website Traffic Packages',
    subtitle_tr: 'Belirttiğiniz web adresine ücretli yönlendirme trafiği sağlayan paketler. Bu trafik organik arama trafiği değildir ve SEO, satış veya reklam geliri sonucu garanti etmez.',
    subtitle_en: 'Paid referral traffic packages for a URL you provide. This is not organic search traffic and does not guarantee SEO, sales or advertising revenue.',
    seo_title_tr: 'Web Sitesi Trafik Paketleri – Şeffaf Kullanım ve Koşullar',
    seo_title_en: 'Website Traffic Packages – Transparent Terms of Use',
    seo_description_tr: 'Web sitesi için ücretli yönlendirme trafiği paketlerini, kullanım koşullarını ve sınırlamalarını inceleyin. Organik trafik veya SEO sonucu değildir.',
    seo_description_en: 'Review paid referral traffic packages, terms and limitations. This is not organic traffic and does not produce or guarantee SEO results.',
    content_tr: [
      '<h2>Trafik paketleri ne sunar?</h2>',
      '<p>Bu sayfadaki paketler, belirttiğiniz web adresine ücretli yönlendirme trafiği gönderir. Trafiğin kaynağı ve teknik özellikleri hizmet kartında açıkça belirtilir. Satın alınan ziyaretler organik arama trafiği değildir; arama motoru sıralamasını, gerçek kullanıcı etkileşimini veya ticari sonucu temsil etmez.</p>',
      '<h2>Hizmet kapsamı</h2>',
      '<ul>',
      '<li><strong>Ücretli yönlendirme trafiği:</strong> Hizmet kartında belirtilen ülke, süre ve miktar koşullarına göre URL\'nize yönlendirilen ziyarettir.</li>',
      '<li><strong>Doğrudan trafik:</strong> Referrer bilgisi olmadan gelebilen ziyaretlerdir. Analiz aracının kaynak sınıflandırması garanti edilmez.</li>',
      '</ul>',
      '<h2>SEO konusunda dürüst uyarı</h2>',
      '<blockquote>Satın alınan trafik, sitenizin Google sıralamasını yükseltmez ve bu sayfadaki hiçbir paket SEO sonucu taahhüt etmez. Reklam geliri, satış, form doldurma, gerçek kullanıcı etkileşimi veya belirli bir analiz metriği garanti edilmez. Reklam yayınlayan sayfalara satın alınmış trafik göndermek reklam ağının politikalarını ihlal edebilir; hizmeti bu amaçla kullanmayın.</blockquote>',
      '<h2>Doğru kullanım</h2>',
      '<p>Sipariş verirken sahip olduğunuz veya trafik gönderme yetkinizin bulunduğu sayfanın tam adresini (https:// ile) girin. Sunucunuzun sipariş hacmini kaldırabildiğinden emin olun. Hizmeti analiz, reklam veya sayaç verilerini yanıltıcı biçimde değiştirmek; platform politikalarını aşmak ya da üçüncü kişilere zarar vermek amacıyla kullanmayın.</p>',
    ...
    content_en: [
      ...
      '<p>The packages on this page send paid referral traffic to a URL you provide. The source and technical conditions are stated on each service card. Purchased visits are not organic search traffic and do not represent search rankings, genuine engagement or commercial results.</p>',
      '<h2>Service scope</h2>',
      '<ul>',
      '<li><strong>Paid referral traffic:</strong> visits directed to your URL under the country, duration and quantity terms shown on the service card.</li>',
      '<li><strong>Direct traffic:</strong> visits that may arrive without referrer data. Classification by an analytics tool is not guaranteed.</li>',
      '</ul>',
      '<h2>An honest note on SEO</h2>',
      '<blockquote>Purchased traffic does not raise your Google ranking, and no package on this page commits to an SEO outcome. Advertising revenue, sales, form submissions, genuine engagement or any particular analytics metric is not guaranteed. Sending purchased traffic to pages running ads may violate the ad network\'s policies; do not use the service for that purpose.</blockquote>',
      '<h2>Using it right</h2>',
      '<p>Submit the full address (including https://) of a page you own or are authorised to promote. Make sure your server can handle the ordered volume. Do not use the service to misrepresent analytics, advertising or counter data, evade platform policies or harm third parties.</p>',
    ...
    faq_tr: [
      { q: 'Trafik analiz araçlarında görünür mü?', a: 'Ölçüm kodunuz ve analiz aracınızın filtreleri uygunsa ziyaretler raporlara yansıyabilir. Belirli bir kaynak, oturum sayısı veya raporlama sonucu garanti edilmez; bu trafik organik arama trafiği değildir.' },
    ...
    faq_en: [
      { q: 'Will the traffic appear in analytics tools?', a: 'Visits may appear when your measurement code and analytics filters allow them. No particular source, session count or reporting result is guaranteed; this is not organic search traffic.' },
